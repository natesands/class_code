...
void copy_test(const sequence& source);

void cc_test(const sequence& source);
...
// Library facilities used: iostream.h
{
    ...
    cout << " X   Test assignment operator" << endl;
    cout << " Y   Test copy constructor" << endl;
}
...
void copy_test(const sequence& source)
{
    ...
    cout << "Original: " << endl;
    show_sequence(source);
    if (source.is_item())
      cout << "Current item is: " << source.current() << endl;
    else
      cout << "No current item." << endl;
    cout << "Size: " << source.size() << endl << endl;

    cout << "Copy: " << endl;
    show_sequence(copy);
    if (copy.is_item())
      cout << "Current item is: " << copy.current() << endl;
    else
      cout << "No current item." << endl;
