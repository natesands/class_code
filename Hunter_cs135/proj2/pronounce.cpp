...
//(i.e., contains non-alpha characters besides apostrophe).
//false otherwise
bool ignoreWord(string s) {
    bool ignore = false;
    int i = 0;
...
//capitalizes any alpha character in string
void allCaps(string& s) {
...
//(function provided by cs135 faculty)
//takes a string, splits it when it encounters a space
//assigns one piece to before, the remainder to after
void splitOnSpace(string s, string & before, string & after) {
...
//takes two strings s1 and s2 and
//returns true if s1 is s2 with one phoneme
//replaced
bool hasReplacedPhone(string s1, string s2) {
...
//takes a string of phonemes
//returns the nth phoneme in string
string getNthPhone(string s, int n) {
